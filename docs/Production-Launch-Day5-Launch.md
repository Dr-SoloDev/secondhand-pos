...
[ ] รับซื้อของ
[ ] ⭐ ค้นหาผู้ขาย → select → แสดงข้อมูล (อันดับแรก)
[ ] ⭐ ตรวจสอบ tier — บิล1 auto ✅ ไม่ต้องกด
[ ] เลือกสาขา
[ ] พิมพ์รหัสสินค้า → ⭐ ถ้าผลลัพธ์เดียว auto-select → focus ข้ามไปน้ำหนัก
[ ] ⭐ focus น้ำหนัก → select-all → กรอก 100 กก.
[ ] กรอกหักน้ำหนัก 2 กก.
