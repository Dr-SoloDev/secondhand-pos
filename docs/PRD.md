...
[STEP 2] พนักงานถาม "เอาอะไรมาขาย"
  │
  ▼
[STEP 3] คีย์รายการสินค้า (วนทีละรายการจนครบ)
  │
  ├── 3.1 เลือก Tier (1/2/3) ก่อน ← ราคาจะ auto-fill
  ├── 3.2 คีย์รหัสสินค้า → ชื่อ + หมวดหมู่ เด้ง auto ← [เร็ว] เพราะพนักงานจำรหัสได้
  ├── 3.3 กรอกน้ำหนัก (kg) ที่ชั่งได้
  ├── 3.4 กรอกหักน้ำหนัก (สิ่งเจือปน)
  ├── 3.5 ราคาคำนวณ auto ตาม Tier
  ├── 3.6 [GAP ❌] ถ่ายรูปสินค้าต่อรายการ ← ตอนนี้ถ่ายได้หลังกดเพิ่มแล้ว
  └── 3.7 [+ เพิ่ม] → เข้า Cart
  │
  ▼
[STEP 4] รวมยอด → Cart แสดงยอดรวม
  │
  ▼
[STEP 5] ขอข้อมูลผู้ขาย
  │
