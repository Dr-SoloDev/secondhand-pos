...
ALTER TABLE branches
  ADD COLUMN IF NOT EXISTS scale_mode ENUM('disabled','auto','required') NOT NULL DEFAULT 'auto'
...
UPDATE branches SET scale_mode = 'auto' WHERE scale_mode IS NULL OR scale_mode = '' OR scale_mode = 'disabled';
